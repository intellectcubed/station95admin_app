...
echo "     sed -i '' \"s|http://localhost:8080|${API_URL}|g\" dist/index.html"
echo "     sed -i '' \"s|http://localhost:8080|${API_URL}|g\" dist/admin.html"
echo ""
echo "  2. Deploy to GitHub Pages:"
echo "     - Remove dist/ from .gitignore"
echo "     - git add dist/ && git commit -m 'Add static files'"
